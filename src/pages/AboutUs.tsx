      ...
      <IonContent fullscreen>
        <IonCard class="card-style">
          ...
          <IonCardContent className="main-card-text">
            Esta aplicación muestra información acerca del turismo canario, a
            través de la visualización de los últimos datos disponibles para
            cuatro de los aspectos más relevantes del sector. Estos datos se
            obtienen del repositorio Canarias Datos Abiertos, de manera que la
            información de la app se actualiza a medida que lo hace esta fuente
            oficial.
          </IonCardContent>
        </IonCard>
        <IonCard class="card-style">
