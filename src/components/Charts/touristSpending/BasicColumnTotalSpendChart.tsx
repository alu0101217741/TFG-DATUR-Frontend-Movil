...
import "./BasicColumnTotalSpendChart.css";
    ...
    dataValue.forEach((item: any) => {
      item.data.forEach((element: any) => {
        if (element.trimester.slice(4) === "Q1")
          values[0].data.push(element.totalSpending as never);
        if (element.trimester.slice(4) === "Q2")
          values[1].data.push(element.totalSpending as never);
        if (element.trimester.slice(4) === "Q3")
          values[2].data.push(element.totalSpending as never);
        if (element.trimester.slice(4) === "Q4")
          values[3].data.push(element.totalSpending as never);
      });
    });
